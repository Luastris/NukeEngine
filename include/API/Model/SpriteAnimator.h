...
public:
	[[nuke::prop(label="Columns", min=1, max=64)]] int   columns     = 1;   // atlas grid width  (cells across)
	[[nuke::prop(label="Rows",    min=1, max=64)]] int   rows        = 1;   // atlas grid height (cells down)
