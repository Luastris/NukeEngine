...
// Dynamic-body settings. Pairs with a Collider on the SAME atom (the Collider supplies the
// shape); the world's fixed-step driver writes the simulated pose back into the Transform.
...
public:
	...
	// Kinematic: not simulated — gameplay moves the Transform and the body pushes dynamic bodies.
